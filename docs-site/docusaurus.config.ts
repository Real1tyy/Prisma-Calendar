...
const config: Config = {
	...
	favicon: "img/prisma_logo.png",

	// Set the production url of your site here
	url: "https://prisma-calendar.matejvavroproductivity.com",
	// Custom domain serves the site at the root, so baseUrl is "/" (not "/Prisma-Calendar/").
	baseUrl: "/",
		...
		[
			"classic",
			{
				docs: {
					...
					editUrl:
						"https://github.com/Real1tyy/Prisma-Calendar/edit/main/docs-site/",
