...
<details>
<summary>How can I improve performance in a large vault?</summary>
...
<details>
<summary>Events are not sorting correctly by Sort Date in Bases</summary>
...
<details>
<summary>My event isn't showing up — what should I check?</summary>
