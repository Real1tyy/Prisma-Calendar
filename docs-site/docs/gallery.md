---
title: Gallery
description: Videos and screenshots showcasing Prisma Calendar features
sidebar_position: 5
---
...
Visual guide to Prisma Calendar features. For detailed documentation on each feature, see [Features Overview](features/overview).
...
### [Monthly + Stats](features/views/monthly-calendar-stats)
<div className="video-container" style={{"textAlign": "center", "marginBottom": "2em"}}>
  <video controls autoPlay loop muted playsInline style={{"width": "100%", "maxWidth": "800px", "borderRadius": "8px"}}>
...
### [Heatmap Monthly + Stats](features/views/heatmap-monthly-stats)
<div className="video-container" style={{"textAlign": "center", "marginBottom": "2em"}}>
  <video controls autoPlay loop muted playsInline style={{"width": "100%", "maxWidth": "800px", "borderRadius": "8px"}}>
...
### [Event Creation & Editing](features/overview#event-creation--editing)
...
Visual time tracking with pie charts and detailed breakdown tables showing how you spend your time across daily, weekly, monthly, and all-time views.
...
Multi-select category assignment modal with search, color indicators, and the ability to create new categories on the fly.
...
CalDAV synchronization setup and ICS import/export workflows for external calendar integration.

## Next Steps

- [Features Overview](features/overview) - Learn about all features
