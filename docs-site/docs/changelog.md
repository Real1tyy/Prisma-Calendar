...
### Fixed
- **All-day events missing from stats counts**: All-day events were dropped from the daily, weekly, monthly, and all-time statistics entirely. They now appear in the table with their counts; durations are still 0 since all-day events have no measurable length. See [Statistics](./features/organization/statistics.md#all-day-events).
