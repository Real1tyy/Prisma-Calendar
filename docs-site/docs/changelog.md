...
- **Programmatic API on `window.PrismaCalendar`**: Initial scripting API with event creation, untracked event creation, file-to-event conversion, modal controls, and ZettelID enforcement. Expanded significantly in v2.6.0. See [Programmatic API](./features/advanced/programmatic-api.md).
