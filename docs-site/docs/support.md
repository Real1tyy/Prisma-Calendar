...
Your contribution allows me to dedicate my time to maintaining, improving, and building new features for Prisma Calendar.

**👉 [Learn more about Advanced Features](./features/free-vs-pro)**
...
- **Subscribe to my channel** — Stay updated with new tutorials, tips, and plugin features
...
If the send fails — you're offline, or the server is having a moment — the error is retryable and your text and attachments are still there.
