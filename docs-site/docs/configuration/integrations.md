...
Configure CalDAV accounts for one-way read-only sync from external calendar servers. See the [CalDAV](../features/advanced/integrations#caldav-integration) documentation.
