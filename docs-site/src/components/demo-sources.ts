// Generated by showrunner (mise run showrunner:publish / install-component).
// Canonical source: shared-react/src/docs/ — edit there, then re-publish; do not edit here.
