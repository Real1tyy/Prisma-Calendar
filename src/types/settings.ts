...
export const GeneralSettingsSchema = z.object({
	...
	showStopwatchStartWithoutFill: z.boolean().default(SETTINGS_DEFAULTS.DEFAULT_SHOW_STOPWATCH_START_WITHOUT_FILL), // show "start without fill" button that starts tracking without updating start date
...
export const PropsSettingsSchema = z.object({
	...
	generatePastEventsProp: z.string().default(SETTINGS_DEFAULTS.DEFAULT_GENERATE_PAST_EVENTS_PROP), // property name for generating past recurring instances from source event start date
